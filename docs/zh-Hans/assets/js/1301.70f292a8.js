...
const DyteLeaveButton = class {
  constructor(hostRef) {
    ...
    this.leave = () => {
      ...
      _store_79928517_js__WEBPACK_IMPORTED_MODULE_3__.s.activeLeaveConfirmation = true;
    };
  }
  render() {
    const text = this.t('leave');
    return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.H, { label: text }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { size: this.size, iconPack: this.iconPack, class: "leave", onClick: this.leave, icon: this.iconPack.call_end, label: text, variant: this.variant })));
  }
};
