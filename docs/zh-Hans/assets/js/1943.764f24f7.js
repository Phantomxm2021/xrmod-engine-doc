...
const DyteSimpleGrid = class {
  ...
  render() {
    ...
    return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.H, null, this.participants.map((participant, index) => {
      const { top, left } = getPosition(index);
      return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_f7bdca7a_js__WEBPACK_IMPORTED_MODULE_4__.R, { element: "dyte-participant-tile", defaults: defaults, props: {
          participant,
          style: {
            position: 'absolute',
            top: `${top}px`,
    ...
    }), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null)));
  }
