...
const DytePlugins = class {
  constructor(hostRef) {
    ...
    this.close = () => {
      ...
      _store_79928517_js__WEBPACK_IMPORTED_MODULE_3__.s.activeSidebar = false;
      _store_79928517_js__WEBPACK_IMPORTED_MODULE_3__.s.sidebar = 'none';
    };
  }
  connectedCallback() {
  ...
  meetingChanged(meeting) {
    if (meeting != null) {
      ...
      const whitelistedPluginsId = (0,_versionTwoApis_e31e770d_js__WEBPACK_IMPORTED_MODULE_4__.i)(meeting.self.suggestedTheme)
        ? []
  ...
  render() {
    return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("ul", { class: "scrollbar" }, this.plugins.map((plugin) => ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("li", { key: plugin.name, class: "plugin" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "metadata" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("img", { src: plugin.picture }), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "name" }, plugin.name)), !this.activatedPluginsId.includes(plugin.id) && this.canStartPlugins && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "buttons" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { kind: "icon", size: "lg", onClick: () => {
        plugin.activate();
        this.close();
      }, "aria-label": `${this.t('Activate')} ${plugin.name}` }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.rocket, tabIndex: -1, "aria-hidden": true })))), this.activatedPluginsId.includes(plugin.id) && this.canClosePlugin && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "buttons" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { kind: "icon", size: "lg", onClick: () => {
        plugin.deactivate();
      }, "aria-label": `${this.t('Close')} ${plugin.name}` }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.dismiss, tabIndex: -1, "aria-hidden": true }))))))))));
  }
