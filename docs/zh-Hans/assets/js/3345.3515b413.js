...
/* harmony import */ var _date_8c24cfe1_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(72512);
/* harmony import */ var _string_133d57e8_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(7743);
/* harmony import */ var _default_icon_pack_754e33a3_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(80335);
/* harmony import */ var _file_52683cc2_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(69083);
...
const DyteEmojiPicker = class {
  ...
  mapEmojiList() {
    ...
    if (((_a = this.emojiList) === null || _a === void 0 ? void 0 : _a.length) > 0) {
      return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { id: "loader" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-spinner", null)));
    }
    return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { id: "emoji-grid", class: "scrollbar" }, this.filteredEmojis.map((e) => ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { key: `emoji-button-${e.name}`, class: "emoji", variant: "ghost", kind: "icon", title: e.name, onClick: () => this.handleEmojiClick(e.emoji) }, e.emoji)))));
  }
  render() {
    return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { value: this.filterVal, onInput: (event) => this.handleInputChange(event.target), placeholder: this.t('Search') }), this.mapEmojiList()));
  }
};
DyteEmojiPicker.style = dyteEmojiPickerCss;

const ChatHead = ({ name, time, now }) => {
  return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "head" },
    (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "name" }, (0,_string_133d57e8_js__WEBPACK_IMPORTED_MODULE_5__.s)((0,_string_133d57e8_js__WEBPACK_IMPORTED_MODULE_5__.f)(name), 20)),
    (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "time", title: (0,_date_8c24cfe1_js__WEBPACK_IMPORTED_MODULE_6__.f)(time) }, (0,_date_8c24cfe1_js__WEBPACK_IMPORTED_MODULE_6__.e)(time, now))));
};
...
const DyteFileMessage = class {
  ...
  render() {
    ...
    return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.H, null, !this.isContinued && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(ChatHead, { name: this.message.displayName, time: this.message.time, now: this.now })), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "body", part: "body" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "file" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "file-data" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "name" }, this.message.name), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "file-data-split" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "ext" }, (0,_file_52683cc2_js__WEBPACK_IMPORTED_MODULE_7__.g)(this.message.name)), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", { class: "divider" }), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "size" }, (0,_file_52683cc2_js__WEBPACK_IMPORTED_MODULE_7__.a)(this.message.size)))), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { variant: "secondary", kind: "icon", onClick: () => (0,_file_52683cc2_js__WEBPACK_IMPORTED_MODULE_7__.d)(link, { name: this.message.name, fallbackName: 'file' }), part: "button" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.download }))))));
  }
};
...
const DyteImageMessage = class {
  ...
  render() {
    return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.H, null, !this.isContinued && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(ChatHead, { name: this.message.displayName, time: this.message.time, now: this.now })), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "body", part: "body" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: { image: true, loaded: this.status === 'loaded' } }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("img", { src: (0,_string_133d57e8_js__WEBPACK_IMPORTED_MODULE_5__.a)(this.message.link), onLoad: () => {
        this.status = 'loaded';
      }, onError: () => {
        this.status = 'errored';
      }, onClick: () => {
        if (this.status === 'loaded') {
          ...
          _store_79928517_js__WEBPACK_IMPORTED_MODULE_3__.s.image = this.message;
        }
      } }), this.status === 'loading' && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "image-spinner", title: this.t('Loading image'), "aria-label": this.t('Loading image') }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-spinner", null))), this.status === 'errored' && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "image-errored", title: this.t('Image not found'), "aria-label": this.t('Image not found') }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.image_off }))), this.status === 'loaded' && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "actions" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { class: "action", variant: "secondary", kind: "icon", onClick: () => {
        this.stateUpdate.emit({ image: this.message });
        _store_79928517_js__WEBPACK_IMPORTED_MODULE_3__.s.image = this.message;
      } }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.full_screen_maximize })), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { class: "action", variant: "secondary", kind: "icon", onClick: () => (0,_file_52683cc2_js__WEBPACK_IMPORTED_MODULE_7__.d)(this.message.link, { fallbackName: 'image' }) }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.download }))))))));
  }
};
...
const formatMessage = (text) => {
  ...
  return words.map((word, index) => {
    if (URLRegEx.test(word)) {
      return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", null,
        (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("a", { href: word, target: "_blank", rel: "noopener noreferrer" }, word),
        index !== lastIndex ? ' ' : ''));
    }
...
const TextMessageView = ({ message }) => {
  ...
  return lines.map((line) => (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", null, formatMessage(line)));
};
...
const DyteTextMessage = class {
  ...
  render() {
    return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.H, null, !this.isContinued && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(ChatHead, { name: this.message.displayName, time: this.message.time, now: this.now })), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "body", part: "body" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: { text: true, emoji: (0,_string_133d57e8_js__WEBPACK_IMPORTED_MODULE_5__.h)(this.message.message) } }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(TextMessageView, { message: this.message.message })))));
  }
};
...
/* harmony export */ });
/* harmony import */ var _string_133d57e8_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7743);
