...
/* harmony import */ var _dyte_client_faf935bd_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(99500);
/* harmony import */ var _full_screen_05839220_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(27275);
...
const DyteScreenshareView = class {
  ...
  render() {
    ...
    return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.H, { class: { isSelf } }, Boolean(((_d = (_c = this.meeting) === null || _c === void 0 ? void 0 : _c.remote) === null || _d === void 0 ? void 0 : _d.active) && this.remoteControlInfo) && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { id: "remote-control-self" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", { class: "remote-control-message" }, this.remoteControlInfo), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { onClick: () => this.meeting.remote.endControl() }, ((_e = this.meeting.remote.active) === null || _e === void 0 ? void 0 : _e.hostPeerId) === this.meeting.self.id
      ? 'Revoke access'
      : 'Stop'))), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { id: "video-container", class: { expand: this.videoExpanded }, contentEditable: true, onKeyDown: this.onKeyDown }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("video", { ref: (el) => (this.videoEl = el), class: {
        visible: this.screenShareEnabled,
      }, playsInline: true, autoPlay: true, muted: true, id: `screen-share-video-${this.participant.id}`, onMouseMove: this.onMouseEvent, onClick: this.onMouseEvent, onContextMenu: this.onMouseEvent })), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { id: "controls" }, !this.hideFullScreenButton && !isSelf && (0,_full_screen_05839220_js__WEBPACK_IMPORTED_MODULE_5__.a)() && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-tooltip", { label: text }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { id: "full-screen-btn", kind: "icon", onClick: this.toggleFullScreen, title: text }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: icon, "aria-hidden": true, tabIndex: -1 })))), ((_f = this.participant) === null || _f === void 0 ? void 0 : _f.supportsRemoteControl) === true && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-menu", { id: "menu" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { variant: "secondary", kind: "icon", slot: "trigger" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.more_vertical })), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-menu-list", null, !isSelf && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-menu-item", { style: {
      ...
      } }, "Request remote control")), isSelf && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-menu-item", { onClick: () => this.stateUpdate.emit({ activeRemoteAccessManager: true }) }, "Manage remote control requests")))))), isSelf && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { id: "self-message" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("h3", null, this.t('Your screen is being shared')), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "actions" }, this.meeting != null && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { variant: "danger", onClick: () => {
        this.meeting.self.disableScreenShare();
      } }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.share_screen_stop, slot: "start" }), this.t('share_screen_stop'))), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { variant: "secondary", id: "expand-btn", onClick: () => {
        this.videoExpanded = !this.videoExpanded;
      } }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.videoExpanded
        ? this.iconPack.full_screen_minimize
        : this.iconPack.full_screen_maximize, slot: "start" }), this.videoExpanded ? this.t('Minimize Preview') : this.t('Expand Preview'))))), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null)));
  }
