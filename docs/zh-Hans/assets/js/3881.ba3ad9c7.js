...
/* harmony import */ var _index_96b0df1d_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(88853);
/* harmony import */ var _index_e51fd65a_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(20975);
/* harmony import */ var _default_icon_pack_754e33a3_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(80335);
/* harmony import */ var _default_ui_config_ae582462_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8976);
/* harmony import */ var _index_f7bdca7a_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(30790);
/* harmony import */ var _config_4a015ff9_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(13217);
/* harmony import */ var _user_prefs_be1700cb_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(79964);
/* harmony import */ var _store_79928517_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(52731);
/* harmony import */ var _versionTwoApis_e31e770d_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(41249);
/* harmony import */ var _commonjsHelpers_9943807e_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(40404);
/* harmony import */ var _default_language_388827b4_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(19261);
/* harmony import */ var _graceful_storage_33bc316d_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(59474);
...
const getIconPack = async (url) => {
  ...
  if (url == null) {
    return _default_icon_pack_754e33a3_js__WEBPACK_IMPORTED_MODULE_3__.d;
  }
  try {
    ...
    return Object.assign({}, _default_icon_pack_754e33a3_js__WEBPACK_IMPORTED_MODULE_3__.d, await res.json());
  }
  catch (_) {
    return _default_icon_pack_754e33a3_js__WEBPACK_IMPORTED_MODULE_3__.d;
  }
...
const DyteMeeting = class {
  constructor(hostRef) {
    ...
    this.roomJoinedListener = () => {
      ...
      _store_79928517_js__WEBPACK_IMPORTED_MODULE_8__.s.meeting = 'joined';
    };
    this.waitlistedListener = () => {
      this.setStates({ meeting: 'waiting' });
      _store_79928517_js__WEBPACK_IMPORTED_MODULE_8__.s.meeting = 'waiting';
    };
    this.roomLeftListener = ({ state: state$1 }) => {
      const states = this.states || _store_79928517_js__WEBPACK_IMPORTED_MODULE_8__.s;
      if ((states === null || states === void 0 ? void 0 : states.roomLeftState) === 'disconnected') {
        this.setStates({ meeting: 'ended' });
        _store_79928517_js__WEBPACK_IMPORTED_MODULE_8__.s.meeting = 'ended';
        return;
      }
      this.setStates({ meeting: 'ended', roomLeftState: state$1 });
      _store_79928517_js__WEBPACK_IMPORTED_MODULE_8__.s.meeting = 'ended';
      _store_79928517_js__WEBPACK_IMPORTED_MODULE_8__.s.roomLeftState = state$1;
    };
    this.mediaPermissionErrorListener = ({ kind }) => {
      if (['audio', 'video'].includes(kind)) {
        this.setStates({ activePermissionsMessage: true });
        _store_79928517_js__WEBPACK_IMPORTED_MODULE_8__.s.activePermissionsMessage = true;
      }
    };
    ...
    this.iconPack = _default_icon_pack_754e33a3_js__WEBPACK_IMPORTED_MODULE_3__.d;
  ...
  connectedCallback() {
    ...
    if (this.applyDesignSystem &&
      ...
      (0,_config_4a015ff9_js__WEBPACK_IMPORTED_MODULE_6__.p)(document.documentElement, this.config.designTokens);
    }
  ...
  meetingChanged(meeting) {
    ...
    if (meeting != null) {
      if (this.loadConfigFromPreset && meeting.self.suggestedTheme != null) {
        ...
        const { config, data } = (0,_versionTwoApis_e31e770d_js__WEBPACK_IMPORTED_MODULE_9__.i)(theme)
          ? { config: _default_ui_config_ae582462_js__WEBPACK_IMPORTED_MODULE_4__.d, data: { showSetupScreen: true } }
          : (0,_config_4a015ff9_js__WEBPACK_IMPORTED_MODULE_6__.g)(theme);
        if (this.config === _default_ui_config_ae582462_js__WEBPACK_IMPORTED_MODULE_4__.d) {
      ...
      if (this.showSetupScreen) {
        ...
        _store_79928517_js__WEBPACK_IMPORTED_MODULE_8__.s.meeting = 'setup';
      }
      else {
  ...
  async languageChanged(lang) {
    this.t = (0,_index_e51fd65a_js__WEBPACK_IMPORTED_MODULE_2__.u)(await (0,_index_e51fd65a_js__WEBPACK_IMPORTED_MODULE_2__.g)(lang));
  }
  listenState(e) {
    e.stopPropagation();
  ...
  initializePreferences() {
    ...
    _store_79928517_js__WEBPACK_IMPORTED_MODULE_8__.s.prefs = prefs;
  }
  handleResize() {
  ...
  render() {
    const defaults = {
      ...
      size: this.size,
      states: this.states || _store_79928517_js__WEBPACK_IMPORTED_MODULE_8__.s,
      config: this.config,
      iconPack: this.iconPack,
      t: this.t,
    };
    return (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_f7bdca7a_js__WEBPACK_IMPORTED_MODULE_5__.R, { element: "dyte-meeting", defaults: defaults, asHost: true });
  }
