...
/* harmony import */ var _user_prefs_be1700cb_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(79964);
/* harmony import */ var _store_79928517_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(52731);
/* harmony import */ var _default_language_388827b4_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(19261);
/* harmony import */ var _graceful_storage_33bc316d_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(59474);
...
const DyteSettingsAudio = class {
  ...
  render() {
    ...
    const states = this.states || _store_79928517_js__WEBPACK_IMPORTED_MODULE_4__.s;
    ...
    return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("audio", { preload: "auto", src: "https://assets.dyte.io/ui-kit/speaker-test.mp3", ref: (el) => (this.testAudioEl = el) }), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "group" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("label", null, "Microphone (input)"), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "row" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("select", { class: "dyte-select", onChange: (e) => this.setDevice('audio', e.target.value) }, this.audioDevices.map(({ deviceId, label }) => {
      var _a;
      return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("option", { value: deviceId, selected: ((_a = currentDevices.audio) === null || _a === void 0 ? void 0 : _a.deviceId) === deviceId }, label || `Microphone ${++unnamedMicCount}`));
    })), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-audio-visualizer", { participant: (_c = this.meeting) === null || _c === void 0 ? void 0 : _c.self }))), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "group" }, this.speakerDevices.length > 0 && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", null, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("label", null, "Speaker (output)"), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "row" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("select", { class: "dyte-select", onChange: (e) => this.setDevice('speaker', e.target.value) }, this.speakerDevices.map(({ deviceId, label }) => {
      var _a;
      return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("option", { value: deviceId, selected: ((_a = currentDevices.speaker) === null || _a === void 0 ? void 0 : _a.deviceId) === deviceId }, label || `Speaker ${++unnamedSpeakerCount}`));
    }))))), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { variant: "secondary", onClick: () => this.testAudio() }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.speaker, slot: "start" }), "Test")), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "group" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "row" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("label", { htmlFor: "notification-toggle" }, "Notification sound"), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-switch", { id: "notification-toggle", checked: !initialNotificationSoundsPreference, onDyteChange: (e) => {
        var _a;
        const { checked } = e.target;
        const muteNotificationSounds = !checked;
        this.stateUpdate.emit({ prefs: { muteNotificationSounds } });
        _store_79928517_js__WEBPACK_IMPORTED_MODULE_4__.s.prefs = Object.assign(Object.assign({}, ((_a = _store_79928517_js__WEBPACK_IMPORTED_MODULE_4__.s.prefs) !== null && _a !== void 0 ? _a : {})), { muteNotificationSounds });
...
const DyteSettingsVideo = class {
  ...
  meetingChanged(meeting) {
    if (meeting == null)
      return;
    (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.w)(async () => {
      var _a;
  ...
  render() {
    ...
    return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "group" }, ((_b = this.meeting.self) === null || _b === void 0 ? void 0 : _b.videoEnabled) === true ? ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-participant-tile", { participant: (_c = this.meeting) === null || _c === void 0 ? void 0 : _c.self, iconPack: this.iconPack, t: this.t, states: states, isPreview: true })) : ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "camera-off-helper" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-participant-tile", { participant: undefined }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", null, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { id: "icon", icon: this.iconPack.video_off, tabIndex: -1, "aria-hidden": true }), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", null, "Camera is off")))))), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "group" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("label", null, "Camera"), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "row" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("select", { class: "dyte-select", onChange: (e) => this.setDevice(e.target.value) }, this.videoDevices.map(({ deviceId, label }) => ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("option", { value: deviceId }, label || `Camera ${++unnamedVideoCount}`)))))), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "group" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "row" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("label", { htmlFor: "mirror-toggle" }, "Mirror my Video"), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-switch", { checked: initialMirrorPreference, onDyteChange: (e) => {
        var _a;
        const { checked } = e.target;
        this.stateUpdate.emit({ prefs: { mirrorVideo: checked } });
        _store_79928517_js__WEBPACK_IMPORTED_MODULE_4__.s.prefs = Object.assign(Object.assign({}, ((_a = _store_79928517_js__WEBPACK_IMPORTED_MODULE_4__.s.prefs) !== null && _a !== void 0 ? _a : {})), { mirrorVideo: checked });
...
/* harmony export */ });
/* harmony import */ var _graceful_storage_33bc316d_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(59474);
