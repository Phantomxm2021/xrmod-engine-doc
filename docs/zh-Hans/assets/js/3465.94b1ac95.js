...
/* harmony import */ var _date_8c24cfe1_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(72512);
/* harmony import */ var _scroll_555bfeb4_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(88514);
...
/* harmony import */ var _graceful_storage_33bc316d_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(59474);
...
const DyteChat = class {
  ...
  render() {
    ...
    return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { id: "dropzone", class: { active: this.dropzoneActivated }, part: "dropzone" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.attach }), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", null, this.t('Drop files/images to send'))), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "chat-container scrollbar", ref: (el) => (this.chatEl = el), part: "container" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "spacer", part: "spacer" }), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "chat", part: "chat" }, this.chat.map((item) => {
      if (item.type === 'chat') {
        const { message } = item;
        ...
        switch (message.type) {
          case 'text':
            return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-text-message", { message: message, now: this.now, isContinued: isContinued }));
          case 'image':
            return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-image-message", { message: message, now: this.now, isContinued: isContinued, iconPack: this.iconPack }));
          case 'file':
            return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-file-message", { message: message, now: this.now, isContinued: isContinued, iconPack: this.iconPack }));
        }
      }
    }))), this.canSend && this.canSendTextMessage && this.emojiPickerEnabled && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-emoji-picker", { t: this.t, onDyteEmojiClicked: this.onEmojiClicked, part: "emoji-picker" })), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("form", { class: "chat-input", part: "chat-input" }, this.canSend && this.canSendTextMessage && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("textarea", { placeholder: "Message..", ref: this.initialiseTextField, onKeyDown: (e) => this.handleKeyDown(e), onKeyUp: (e) => this.handleKeyUp(e), onInput: this.persistTextMessage, autoFocus: true, onPaste: (e) => {
        const data = e.clipboardData || e.originalEvent.clipboardData;
        this.handleFilesDataTransfer(data.items);
      }, part: "textarea" })), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "chat-buttons", part: "chat-buttons" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "left", part: "chat-buttons-left" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-tooltip", { size: this.size, label: this.t(this.autoScrollEnabled ? 'Autoscroll enabled' : 'Autoscroll disabled') }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { variant: "ghost", kind: "icon", onClick: () => this.toggleAutoScroll(!this.autoScrollEnabled), title: this.t(this.autoScrollEnabled ? 'Autoscroll enabled' : 'Autoscroll disabled') }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.autoScrollEnabled
        ? this.iconPack.vertical_scroll
        : this.iconPack.vertical_scroll_disabled }))), this.canSend &&
      this.canSendFiles && [
      (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-tooltip", { label: this.t('Send a file'), size: this.size }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { variant: "ghost", kind: "icon", onClick: () => this.uploadFile('file'), title: this.t('Send a file') }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.attach }))),
      (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-tooltip", { label: this.t('Send an image'), size: this.size }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { variant: "ghost", kind: "icon", onClick: () => this.uploadFile('image'), title: this.t('Send an image') }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.image }))),
    ], this.canSend && this.canSendTextMessage && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-tooltip", { label: this.t('Send Emoji'), size: this.size }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { variant: "ghost", kind: "icon", class: { active: this.emojiPickerEnabled }, title: this.t('Send Emoji'), onClick: this.toggleEmojiPicker }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.emoji_multiple }))))), this.canSend && this.canSendTextMessage && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "right", part: "chat-buttons-right" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-tooltip", { variant: "primary", label: this.t('Send message'), size: this.size, delay: 2000 }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { kind: "icon", onClick: () => this.handleSendMessage(), title: this.t('Send message') }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.send })))))))));
  }
