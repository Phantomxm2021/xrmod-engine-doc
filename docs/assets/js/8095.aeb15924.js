...
/* harmony import */ var _string_133d57e8_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(7743);
...
const DyteMixedGrid = class {
  ...
  screenShareParticipantsChanged(participants = []) {
    if (this.activeTab == null && participants.length > 0) {
      this.activeTab = { type: 'screenshare', participant: participants[0] };
    }
    else {
  ...
  reassignActiveTab() {
    if (this.screenShareParticipants.length > 0) {
      this.activeTab = { type: 'screenshare', participant: this.screenShareParticipants[0] };
    }
  ...
  render() {
    ...
    return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("main", { id: "main-view", part: "main-view" }, this.shouldShowSwitcher() && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { id: "switcher", key: "switcher" }, this.screenShareParticipants.map((participant) => {
      var _a, _b, _c;
      const name = (0,_string_133d57e8_js__WEBPACK_IMPORTED_MODULE_6__.f)(participant.name);
      return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { title: `${name}'s Screen Share`, key: participant.id, kind: "icon", class: {
          tab: true,
        ...
        }, onClick: () => (this.activeTab = { type: 'screenshare', participant }) }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "center" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.share_screen_person }), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", { class: "name" }, participant.id === ((_c = this.meeting) === null || _c === void 0 ? void 0 : _c.self.id)
        ? this.t('You')
        : (0,_string_133d57e8_js__WEBPACK_IMPORTED_MODULE_6__.s)(name, 6)))));
    }), this.plugins.map((plugin) => {
      var _a, _b;
      return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { title: plugin.name, key: plugin.id, kind: "icon", class: {
          tab: true,
        ...
        }, onClick: () => (this.activeTab = { type: 'plugin', plugin }) }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "center" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("img", { src: plugin.picture }), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", { class: "name" }, (0,_string_133d57e8_js__WEBPACK_IMPORTED_MODULE_6__.s)(plugin.name, 6)))));
    }))), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { id: "tabs", key: "tabs" }, this.screenShareParticipants.map((participant) => {
      var _a, _b;
      return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_f7bdca7a_js__WEBPACK_IMPORTED_MODULE_4__.R, { element: "dyte-screenshare-view", defaults: defaults, props: {
          participant,
          key: participant.id,
          style: {
      ...
      var _a, _b;
      return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_f7bdca7a_js__WEBPACK_IMPORTED_MODULE_4__.R, { element: "dyte-plugin-main", defaults: defaults, props: {
          plugin,
          key: plugin.id,
          style: {
    ...
    }))), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_f7bdca7a_js__WEBPACK_IMPORTED_MODULE_4__.R, { element: "dyte-mixed-grid", defaults: defaults, childProps: {
