...
/* harmony import */ var _store_79928517_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(52731);
...
const DyteParticipantTile = class {
  ...
  isMirrored() {
    ...
    if (this.participant != null) {
      ...
      if (isSelf) {
        const states = this.states || _store_79928517_js__WEBPACK_IMPORTED_MODULE_1__.s;
  ...
  render() {
    var _a, _b, _c, _d;
    return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("video", { ref: (el) => (this.videoEl = el), class: {
      ...
      }, autoPlay: true, playsInline: true, muted: true }), this.isPinned && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { class: "pinned-icon", icon: this.iconPack.pin, "aria-label": this.t('Pinned') })), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null)));
  }
