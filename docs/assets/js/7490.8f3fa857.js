...
/* harmony import */ var _dyte_client_faf935bd_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(99500);
/* harmony import */ var _logger_52e6d49d_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(28706);
/* harmony import */ var _string_133d57e8_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(7743);
...
/* harmony import */ var _commonjsHelpers_9943807e_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(40404);
...
const DyteNotifications = class {
  ...
  meetingChanged(meeting) {
    if (meeting != null) {
      ...
      this.participantJoinedListener = (participant) => {
        if (this.permissions.notifications.participant_joined) {
          this.add({
            ...
            message: `${(0,_string_133d57e8_js__WEBPACK_IMPORTED_MODULE_8__.f)(participant.name)} just joined`,
      ...
      this.participantLeftListener = (participant) => {
        if (this.permissions.notifications.participant_left) {
          this.add({
            ...
            message: `${(0,_string_133d57e8_js__WEBPACK_IMPORTED_MODULE_8__.f)(participant.name)} left`,
            image: participant.picture,
            duration: 2100,
          });
        }
      ...
      this.waitlistedParticipantJoinedListener = (participant) => {
        ...
        this.add({
          id,
          message: `${(0,_string_133d57e8_js__WEBPACK_IMPORTED_MODULE_8__.f)(participant.name)} is requesting to join the meeting`,
          image: participant.picture,
          ...
          if (message.type === 'text') {
            if (this.permissions.notifications.chat) {
              this.add({
                id: `message-${Math.random().toString(36)}`,
                icon: this.iconPack.chat,
                message: `${message.displayName}: ${(0,_string_133d57e8_js__WEBPACK_IMPORTED_MODULE_8__.s)(message.message, 20)}`,
                duration: DEFAULT_NOTIFICATION_DURATION,
              });
            }
      ...
      this.networkUpdateListener = ({ event }) => {
        ...
        if (event === 'disconnected') {
          ...
          this.disconnectTimeout = setTimeout(() => {
            ...
            _store_79928517_js__WEBPACK_IMPORTED_MODULE_5__.s.roomLeftState = 'disconnected';
  ...
  render() {
    return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.H, null, this.notifications.map((notification) => ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-notification", { size: this.size, key: notification.id, "data-id": notification.id, notification: notification, onDyteNotificationDismiss: (e) => this.handleDismiss(e) })))));
  }
...
/* harmony export */ });
/* harmony import */ var _commonjsHelpers_9943807e_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(40404);
