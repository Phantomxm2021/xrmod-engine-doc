...
const DytePermissionsMessage = class {
  constructor(hostRef) {
    ...
    this.continue = () => {
      ...
      _store_79928517_js__WEBPACK_IMPORTED_MODULE_3__.s.activePermissionsMessage = false;
    };
    this.reload = () => {
  ...
  render() {
    ...
    return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("h2", null, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { class: "text-icon", icon: this.iconPack.warning }), isDeniedBySystem ? this.t('perm_sys_denied') : this.t('perm_denied_title')), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", null, this.t('perm_denied_text')), isDeniedBySystem && (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", null, this.t('perm.sys_denied.message')), !isDeniedBySystem && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("a", { class: "need-help-link", href: this.getLink(), target: "_blank", rel: "noreferrer external noreferrer noopener" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { class: "text-icon", icon: this.iconPack.attach }), this.t('Need help on how to do this?'))), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "actions" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { size: "lg", kind: "wide", variant: "secondary", onClick: this.continue }, this.t('Continue as it is')), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { size: "lg", kind: "wide", onClick: this.reload }, this.t('Reload'))), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null)));
  }
