...
const DyteNotification = class {
  constructor(hostRef) {
    ...
    this.dismiss = (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.c)(this, "dyteNotificationDismiss", 7);
    /** Icon pack */
  ...
  render() {
    return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "ctr" }, this.notification.icon != null && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { class: "icon", icon: this.notification.icon })), this.notification.image != null &&
      this.notification.icon == null &&
      this.imageState !== 'errored' && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("img", { src: this.notification.image, class: { loaded: this.imageState === 'loaded' }, onLoad: () => (this.imageState = 'loaded'), onError: () => (this.imageState = 'errored') })), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", { class: "message" }, this.notification.message), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "right" }, this.notification.button != null && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { variant: this.notification.button.variant, onClick: () => this.notification.button.onClick() }, this.notification.button.text)), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { "aria-label": this.t('dismiss'), class: "dismiss", icon: this.iconPack.dismiss, onClick: () => this.dismiss.emit(this.notification.id) })))));
  }
