...
const DyteSettingsToggle = class {
  ...
  toggleSettings() {
    ...
    _store_79928517_js__WEBPACK_IMPORTED_MODULE_3__.s.activeSettings = !_store_79928517_js__WEBPACK_IMPORTED_MODULE_3__.s.activeSettings;
  }
  render() {
    const text = this.t('settings');
    return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.H, { title: text }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { part: "controlbar-button", size: this.size, iconPack: this.iconPack, onClick: () => this.toggleSettings(), icon: this.iconPack.settings, label: text, variant: this.variant })));
  }
};
