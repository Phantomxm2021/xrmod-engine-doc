...
/* harmony import */ var _versionTwoApis_e31e770d_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(41249);
...
const DyteSettings = class {
  ...
  meetingChanged(meeting) {
    if (meeting != null) {
      ...
      this.canProduceVideo = (0,_versionTwoApis_e31e770d_js__WEBPACK_IMPORTED_MODULE_4__.c)(_versionTwoApis_e31e770d_js__WEBPACK_IMPORTED_MODULE_4__.P.Video, meeting.self.permissions);
  ...
  close() {
    ...
    _store_79928517_js__WEBPACK_IMPORTED_MODULE_3__.s.activeSettings = false;
  }
  render() {
    ...
    const defaults = {
      ...
      states: this.states || _store_79928517_js__WEBPACK_IMPORTED_MODULE_3__.s,
      iconPack: this.iconPack,
      t: this.t,
    };
    return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("aside", { class: { hide: this.isMobileMainVisible }, part: "menu" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("header", null, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("h2", null, this.t('settings'))), this.canProduceAudio && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("button", { type: "button", class: { active: this.activeTab === 'audio' }, onClick: () => this.changeTab('audio') }, this.t('audio'), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "right" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.mic_on }), this.size === 'sm' && (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.chevron_right })))), this.canProduceVideo && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("button", { type: "button", class: { active: this.activeTab === 'video' }, onClick: () => this.changeTab('video') }, this.t('video'), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "right" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.video_on }), this.size === 'sm' && (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.chevron_right })))), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("button", { type: "none", title: `Your network condition is ${this.networkStatus}` }, this.t('connection'), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "right" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.wifi, class: this.networkStatus })))), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("main", { class: { active: this.isMobileMainVisible }, part: "main-content" }, this.size === 'sm' && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("header", null, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { kind: "icon", class: "back-btn", onClick: () => (this.isMobileMainVisible = false) }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.chevron_left })), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("h2", null, this.t(this.activeTab === 'audio' ? 'audio' : 'video')))), this.activeTab === 'audio' && (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-settings-audio", Object.assign({}, defaults)), this.activeTab === 'video' && (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-settings-video", Object.assign({}, defaults)))));
  }
