...
const DyteMoreToggle = class {
  constructor(hostRef) {
    ...
    this.toggleMoreMenu = () => {
      ...
      _store_79928517_js__WEBPACK_IMPORTED_MODULE_3__.s.activeMoreMenu = this.isOpen;
    };
  }
  render() {
    ...
    return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.H, { title: text }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { size: this.size, iconPack: this.iconPack, onClick: () => this.toggleMoreMenu(), icon: icon, label: text, part: "controlbar-button" })));
  }
};
