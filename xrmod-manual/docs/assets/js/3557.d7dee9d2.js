...
/* harmony import */ var _index_f7bdca7a_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(30790);
/* harmony import */ var _default_ui_config_ae582462_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8976);
/* harmony import */ var _store_79928517_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(52731);
/* harmony import */ var _versionTwoApis_e31e770d_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(41249);
/* harmony import */ var _default_language_388827b4_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(19261);
...
const DyteSidebar = class {
  constructor(hostRef) {
    ...
    /** Config */
    this.config = _default_ui_config_ae582462_js__WEBPACK_IMPORTED_MODULE_4__.d;
    /** Icon pack */
    ...
    this.close = () => {
      ...
      _store_79928517_js__WEBPACK_IMPORTED_MODULE_5__.s.sidebar = this.tab;
    };
  }
  connectedCallback() {
    this.viewChanged(this.view);
    this.statesChanged(this.states);
    (0,_store_79928517_js__WEBPACK_IMPORTED_MODULE_5__.o)('sidebar', () => this.statesChanged());
  }
  disconnectedCallback() {
    this.keydownListener && document.removeEventListener('keydown', this.keydownListener);
  }
  statesChanged(s) {
    const states = s || _store_79928517_js__WEBPACK_IMPORTED_MODULE_5__.s;
  ...
  filterSections(sections) {
    if (!this.meeting.self.suggestedTheme)
      return sections;
    if ((0,_versionTwoApis_e31e770d_js__WEBPACK_IMPORTED_MODULE_6__.i)(this.meeting.self.suggestedTheme))
      return sections;
  ...
  viewSection(section) {
    ...
    _store_79928517_js__WEBPACK_IMPORTED_MODULE_5__.s.activeSidebar = true;
    _store_79928517_js__WEBPACK_IMPORTED_MODULE_5__.s.sidebar = this.tab;
  }
  render() {
    const defaults = {
    ...
    return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.H, null, this.view === 'full-screen' && [
      (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("h3", { class: "title" }, this.t('About Call')),
      (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { id: "mobile-header" }, this.filterSections(this.enabledSections).map((section) => ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { key: section, variant: "ghost", class: { active: this.tab === section }, onClick: () => this.viewSection(section) }, this.t(section))))),
    ], (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { variant: "ghost", kind: "icon", class: "close", onClick: this.close, "aria-label": this.t('Close') }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.dismiss })), this.view !== 'full-screen' && (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("h3", { class: "title" }, this.t(this.tab)), this.tab === 'chat' && (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_f7bdca7a_js__WEBPACK_IMPORTED_MODULE_3__.R, { element: "dyte-chat", defaults: defaults }), this.tab === 'polls' && (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_f7bdca7a_js__WEBPACK_IMPORTED_MODULE_3__.R, { element: "dyte-polls", defaults: defaults }), this.tab === 'participants' && (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_f7bdca7a_js__WEBPACK_IMPORTED_MODULE_3__.R, { element: "dyte-participants", defaults: defaults }), this.tab === 'plugins' && (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_f7bdca7a_js__WEBPACK_IMPORTED_MODULE_3__.R, { element: "dyte-plugins", defaults: defaults })));
  }
