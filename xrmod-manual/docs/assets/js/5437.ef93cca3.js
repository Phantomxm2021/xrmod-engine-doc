...
const DyteControlbarButton = class {
  ...
  render() {
    return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("button", { "aria-label": this.label, disabled: this.disabled, part: "button" }, this.isLoading ? ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-spinner", { id: "icon", part: "spinner" })) : ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { id: "icon", icon: this.icon, tabIndex: -1, "aria-hidden": true, part: "icon" })), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", { class: "label", part: "label" }, this.label), this.showWarning && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { id: "warning-indicator", icon: this.iconPack.warning, part: "warning-indicator" })))));
  }
};
