...
const dyteParticipantsToggleCss = ":host{position:relative;display:block;font-family:var(--dyte-font-family, sans-serif)}.waiting-participants-count{position:absolute;right:var(--dyte-space-3, 12px);box-sizing:border-box;padding:var(--dyte-space-0\\.5, 2px);-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;--tw-bg-opacity:1;background-color:rgba(var(--dyte-colors-brand-500, 33 96 253) / var(--tw-bg-opacity));font-size:12px;display:flex;height:var(--dyte-space-5, 20px);min-width:var(--dyte-space-5, 20px);align-items:center;justify-content:center;border-radius:9999px;z-index:1}:host([variant='horizontal']){display:flex;flex-direction:row-reverse;align-items:center}:host([variant='horizontal']) .waiting-participants-count{right:var(--dyte-space-4, 16px);top:auto}";
...
const DyteParticipantsToggle = class {
  ...
  connectedCallback() {
    ...
    (0,_store_79928517_js__WEBPACK_IMPORTED_MODULE_3__.o)('sidebar', () => this.statesChanged());
  }
  ...
  statesChanged(s) {
    const states = s || _store_79928517_js__WEBPACK_IMPORTED_MODULE_3__.s;
    if (states != null) {
      this.participantsActive = states.activeSidebar === true && states.sidebar === 'participants';
    }
  }
  toggleParticipantsTab() {
    const states = this.states || _store_79928517_js__WEBPACK_IMPORTED_MODULE_3__.s;
    ...
    _store_79928517_js__WEBPACK_IMPORTED_MODULE_3__.s.activeSidebar = this.participantsActive;
    _store_79928517_js__WEBPACK_IMPORTED_MODULE_3__.s.sidebar = this.participantsActive ? 'participants' : 'none';
  ...
  render() {
    ...
    if (theme &&
      !(0,_versionTwoApis_e31e770d_js__WEBPACK_IMPORTED_MODULE_4__.i)(theme) &&
      ...
      return;
    return ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.H, { title: text }, this.waitlistedParticipants.length !== 0 && !this.participantsActive && ((0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "waiting-participants-count", part: "waiting-participants-count" }, (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", null, this.waitlistedParticipants.length <= 100
      ? this.waitlistedParticipants.length
      : '99+'))), (0,_index_74ddb327_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { part: "controlbar-button", size: this.size, iconPack: this.iconPack, class: { active: this.participantsActive }, onClick: () => this.toggleParticipantsTab(), icon: this.iconPack.participants, label: text, variant: this.variant })));
  }
